...
<body>
           ...
           <div class="main-menu">
                ...
                <ul class="lvl-1-wrapp">
                    ...
                    <li class="lvl-1 xs-open-close">
                        <a href="community.html">COMMUNITY<div class="xs-open-close-icon"></div></a>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?sensor=false&key=AIzaSyABPbXEkXvc5vH0py6OQAhSjHRWsF1cMZU&callback=initMap&language=en" async defer></script>
    <script>
        function initMap() {
