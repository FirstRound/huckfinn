...
<body>
        ...
        <div class="main-m-w">
            <div class="flex-footer">
                <ul>
                    ...
                    <li>
                        <a href="coming-soon.html">MERCH</a>
                    </li>
                    <li>
                        <a href="accessibility.html">Handicap Accessibility</a>
                    </li>
           ...
           <div class="main-menu">
                ...
                <ul class="lvl-1-wrapp">
                    ...
                    <li class="lvl-1 xs-open-close">
                        <a href="community.html">MERCH<div class="xs-open-close-icon"></div></a>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDEEROOCklkbdM8M4DbtSNbssim8T0OPa8&callback=initMap&language=en" async defer></script>
    <script>
        function initMap() {
